...
const Hero = () => {
    ...
    return (
    <>
        <div id='photo-container' className='d-flex flex-row align-items-center justify-content-center'>
        ...
        <div id='landing-page-container' className='container-md w-100 d-flex flex-row align-items-center'>
            <div className='h-100 w-50 w-100 d-flex flex-column align-items-start justify-content-center'>
                ...
                <div className='py-4'>
                    ...
                    <p className='text-secondary' style={{width: 500}}>
            ...
            <div id='video' className="d-flex flex-column align-items-center mt-5">
